...
<div class="flex flex-col md:flex-row h-screen bg-gray-100 dark:bg-gray-900">
    ...
    <div class="flex-1 p-4 pl-16 md:p-10">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">Daftar Barang</h1>
                    ...
                    <tr class="text-gray-700 dark:text-gray-200">
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm">
                            @if ($barang->foto_barang)
                                <img src="{{ asset($barang->foto_barang) }}" alt="Foto Barang" class="w-16 h-16 object-cover rounded">
                            @else
                                Tidak ada foto
                            @endif
                        </td>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        searchBarang.addEventListener('keyup', function () {
            ...
            fetch(`{{ route('petugas.barang.search') }}?query=${query}`)
                        ...
                        data.forEach(barang => {
                            const row = `
                                <tr class="text-gray-700 dark:text-gray-200">
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm">
                                        ${barang.foto_barang ? `<img src="${barang.foto_barang}" alt="Foto Barang" class="w-16 h-16 object-cover rounded">` : 'Tidak ada foto'}
                                    </td>
                                </tr>
                            `;
